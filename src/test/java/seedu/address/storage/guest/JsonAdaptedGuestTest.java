...
class JsonAdaptedGuestTest {
    ...
    public void toModelType_nullPassportNumber_throwsIllegalValueException() {
        JsonAdaptedGuest person = new JsonAdaptedGuest(VALID_NAME, VALID_EMAIL, VALID_TAGS, VALID_ROOM_NUMBER, null);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedGuest person = new JsonAdaptedGuest(null, VALID_EMAIL, VALID_TAGS,
                VALID_ROOM_NUMBER, VALID_PASSPORT_NUMBER);
    ...
    public void toModelType_nullRoomNumber_throwsIllegalValueException() {
        JsonAdaptedGuest person = new JsonAdaptedGuest(VALID_NAME, VALID_EMAIL, VALID_TAGS, null, VALID_PASSPORT_NUMBER);
