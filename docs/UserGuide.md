...
* **`checkin`**`n/John Doe pn/X12345678F r/123 e/johnd@example.com t/Senior Citizen` : Adds a guest named `John Doe` to the Address Book.
...
`clearguest` command would remove all guest and this action is irreversible. Only use this command if you really need to wipe all current guest data. 
</div>  
